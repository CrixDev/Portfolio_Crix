    ...
    return(
        ...
        <aside 
         className={`flex flex-col items-center ${
            isOpen ? "w-64  " : "w-16"
          } h-screen py-8 overflow-y-auto bg-white border-r dark:bg-gray-900 dark:border-gray-700 transition-all duration-300`}
        >

<button
          onClick={toggleSidebar}
          className="p-2 mb-6 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg"
        >
          {isOpen ? "⬅️" : "➡️"}
        </button>
